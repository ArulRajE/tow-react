...
const DispatcherManagement = () => {
  ...
  const getData = React.useCallback(() => {
    UserService.getAllUsersByRole('Dispatcher')
      .then((res) => {
        if (res && res.results) {
  ...
  return (
    <Grid item xs={12} sm={6} lg={12} spacing={gridSpacing}>
      <MainCard style={{ padding: 0 }} title="Dispatcher Management" darkTitle=" ">
          ...
          <CardContent>
            <Grid container justifyContent="space-between" alignItems="center" spacing={2}>
              ...
              <Grid item xs={12} sm={6} sx={{ textAlign: 'right' }}>
                <Tooltip title="Add Dispatcher">
                  <IconButton size="small" component={Link} to="/settings/role-management" color="primary"></IconButton>
                </Tooltip>
                <Tooltip title="Add Dispatcher">
                  <Fab
                    color="primary"
