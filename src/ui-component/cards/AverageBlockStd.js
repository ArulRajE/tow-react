...
export default function EnhancedTable({ settings, LocalstartTime, LocalendTime, id }) {
    ...
    React.useEffect(() => {
        ...
        analysisServices
            .averagestd(LocalstartTime, LocalendTime)
            .then(async (results) => {
                const { data } = results;
                                        ...
                                        return (
                                            ...
                                            >
                                                {headCells.map((headCell) => (
                                                    ...
                                                    >
                                                        {getFilteredValue(headCell, row[headCell.columnName], row.tagName)}
                                                    </StyledTableCell>
                                                ))}
                                            </StyledTableRow>
                                        );
